    ...
    import ict.db.ReservationDB; // Assuming report methods are added here
    ...
    public class ConsumptionReportController extends HttpServlet {
        ...
        private ReservationDB reservationDb; // Contains report methods
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                startDate = (startDateStr != null && !startDateStr.isEmpty()) ? Date.valueOf(startDateStr) : Date.valueOf(endDate.toLocalDate().minusDays(30));
            ...
            try {
                reportData = reservationDb.getConsumptionSummaryByFruit(startDate, endDate);
                LOGGER.log(Level.INFO, "Fetched consumption report data for range: {0} to {1}", new Object[]{startDate, endDate});
            } catch (Exception e) {
